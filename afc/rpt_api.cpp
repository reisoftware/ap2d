...
/////////////////////// << def >> ///////////////////////
#define rpt_return_ptr(ptr, result)	\
	if(!ptr){	\
		return result;	\
	}

#define rpt_return_aryptr(aryptr, result)	\
	if(!aryptr || aryptr->empty()){	\
		return result;	\
	}
...
{
	rpt_tcc_ptr(rpt_api.table_dats, "api::clear_table_dats()");
...
{
	rpt_tcc_ptr(rpt_api.sheet_pos, "api::set_sheet_w()");
	rpt_api.sheet_pos->w = w;
}

void rpt_set_sheet_h(int h)
{
	rpt_tcc_ptr(rpt_api.sheet_pos, "api::set_sheet_h()");
...
int rpt_get_table_x()
{
	rpt_tcc_ptr(rpt_api.table_pos, "api::get_table_x()");
	return rpt_api.table_pos->x;
}
int rpt_get_table_y()
{
	rpt_tcc_ptr(rpt_api.table_pos, "api::get_table_y()");
	return rpt_api.table_pos->y;
}

void rpt_set_table_x(int x)
{
	rpt_tcc_ptr(rpt_api.table_pos, "api::set_table_x()");
	rpt_api.table_pos->x = x;
}
void rpt_set_table_y(int y)
{
	rpt_tcc_ptr(rpt_api.table_pos, "api::set_table_y()");
...
{
	rpt_tcc_ptr(rpt_api.column_pos, "api::set_column_x()");
	rpt_api.column_pos->x = x;
}

void rpt_set_column_y(int y)
{
	rpt_tcc_ptr(rpt_api.column_pos, "api::set_column_y()");
	rpt_api.column_pos->y = y;
}

void rpt_set_column_w(int w)
{
	rpt_tcc_ptr(rpt_api.column_pos, "api::set_column_w()");
	rpt_api.column_pos->w = w;
}

void rpt_set_column_h(int h)
{
	rpt_tcc_ptr(rpt_api.column_pos, "api::set_column_h()");
...
{
	std::vector<afc::Dat*>* super_dats = rpt_api.super_dats;
	if(!super_dats || super_dats->empty()){
		return NULL;
	}
	int aaa = rpt_api.super_dats->size();
	rpt_tcc_aryptr(rpt_api.super_dats, "api::get_super_dats_item()");
...
{
	rpt_return_ptr(rpt_api.cur_dat, NULL);
	rpt_tcc_ptr(rpt_api.cur_dat, "api::get_curitem()");
...
void * rpt_get_item1()
{
	rpt_return_ptr(rpt_api.dat1, NULL);
	rpt_tcc_ptr(rpt_api.dat1, "api::get_item()");
...
void * rpt_get_item2()
{
	rpt_return_ptr(rpt_api.dat2, NULL);
	rpt_tcc_ptr(rpt_api.dat2, "api::get_item2()");
...
{
	rpt_return_aryptr(rpt_api.group1, 0);
	rpt_tcc_aryptr(rpt_api.group1, "api::get_group1_size()");
	return the::get_group(rpt_api.group1).size();
}

int rpt_get_group2_size()
{
	rpt_return_aryptr(rpt_api.group2, 0);
	rpt_tcc_aryptr(rpt_api.group2, "api::get_group2_size()");
	return the::get_group(rpt_api.group2).size();
}

void * rpt_get_group1_item(int iid)
{
	rpt_return_aryptr(rpt_api.group1, NULL);
	rpt_tcc_aryptr(rpt_api.group1, "api::get_group1_item()");
	return the::get_steel(rpt_api.group1, iid);
}
void * rpt_get_group2_item(int iid)
{
	rpt_return_aryptr(rpt_api.group2, NULL);
	rpt_tcc_aryptr(rpt_api.group2, "api::get_group2_item()");
...
{
	rpt_return_aryptr(rpt_api.curgroup, 0);
	rpt_tcc_aryptr(rpt_api.curgroup, "api::get_crugroup_size()");
	return the::get_group(rpt_api.curgroup).size();
}

void * rpt_get_curgroup_item(int iid)
{
	rpt_return_aryptr(rpt_api.curgroup, NULL);
	rpt_tcc_aryptr(rpt_api.curgroup, "api::get_crugroup_item()");
