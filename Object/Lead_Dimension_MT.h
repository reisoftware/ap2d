// Lead_Dimension_MT.h: interface for the Lead_Dimension_MT class.
//
//////////////////////////////////////////////////////////////////////

#ifndef AFX_LEAD_DIMENSION_H__E0CB89BA_984C_4D8E_9972_407981C69BEB__INCLUDED__
#define AFX_LEAD_DIMENSION_H__E0CB89BA_984C_4D8E_9972_407981C69BEB__INCLUDED__
...
namespace dlhml{
class Line;
class OBJECT_API Lead_Dimension_MT : public Dimension
{
	MY_DECLARE_DYNCREATE(Lead_Dimension_MT)
public:
	Lead_Dimension_MT();
	Lead_Dimension_MT(const Lead_Dimension_MT& rhs);
	Lead_Dimension_MT& operator=(const Lead_Dimension_MT& rhs);
	virtual ~Lead_Dimension_MT();
