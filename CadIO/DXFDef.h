...
//<Author>:zhong
//<Add>=Date:2007/11/19
#define	ZB_BYBLOCK		0x0304
#define	ZB_BYLAYER		0x0308
#define	ZB_ELSE			0x0000

#define	ZB_COLOR		0x4001
#define	ZB_LAYER		0x4002
#define	ZB_LTYPE		0x4004
...
typedef struct tag_DXFENTDIMENSION {
	...
	char		DimText[1024];
	//×¢Òâ¶ÁÐ´¶¼ÒªÐÞ¸Ä
	char		dim_kind[1024];//¼üÖµ100µÄ²ÎÊý
	double		dimline_angle;//±ê×¢ÏßµÄ½Ç¶È£¬¼üÖµ50
	REALPOINT	line2_dim_angle_pos;
	REALPOINT	pt_10;
	REALPOINT	pt_13;
	REALPOINT	pt_14;
	REALPOINT	pt_16;
