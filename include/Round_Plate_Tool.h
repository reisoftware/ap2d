#ifndef _ROUND_PLATE_TOOL_H_
#define _ROUND_PLATE_TOOL_H_
#include "..\include\ModelTool.h"
#include "pt3d.h"
namespace gelib{
	class Scene;
	class Tool_Handle;
	class Select_State;
template <> class Scene_Tool<ROUND_PLATE>:public Tool_Base{
		enum{value = ROUND_PLATE};
		Scene* s_;
		CPt3D pt_;
public:
